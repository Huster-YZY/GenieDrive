...
class EE_FormerEncoder(CustomTransformerLayerSequence):
    """
    ...
    def __init__(self,
        ...
        super(EE_FormerEncoder, self).__init__(*args, **kwargs)
...
class EE_FormerEncoderLayer(MyCustomBaseTransformerLayer):
    ...
    def __init__(self,
                 ...
                 memory_h=8,
                 **kwargs):
        super(EE_FormerEncoderLayer, self).__init__(
            attn_cfgs=attn_cfgs,
