...
for eval_idx in local_samples:
    if os.path.exists(os.path.join(save_path, f'{eval_idx:06d}_CAM_FRONT.mp4')):
        continue
    ...
    for cam_name in cam_names:
        ...
        assert os.path.exists(video_path) and os.path.exists(img_path), f'{video_path} or {img_path} does not exist.'
            ...
            if video_length == 1:
                ...
                if not view_by_view:
                    ...
                    for i, cam_name in enumerate(cam_names):
                        view_path = os.path.join(save_path, f'{eval_idx:06d}_{cam_name}.mp4')
